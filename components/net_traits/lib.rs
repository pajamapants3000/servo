...
impl ResourceFetchTiming {
    ...
    pub fn set_attribute_from(&mut self, to: ResourceAttribute, from: ResourceAttribute) {
        ...
        match to {
            ...
            ResourceAttribute::RedirectCount(_) => { panic!("Use `set_attribute` to set ResourceAttribute::RedirectCount.") },
            ...
            ResourceAttribute::SecureConnectionStart => {
                self.secure_connection_start = val
            },
            ResourceAttribute::ResponseEnd => self.response_end = val,
        }
    }

    pub fn reset_attribute(&mut self, attribute: ResourceAttribute) {
        match attribute {
            ResourceAttribute::DomainLookupStart => self.domain_lookup_start = 0,
            ResourceAttribute::RedirectCount(_) => { panic!("Use `set_attribute` to set ResourceAttribute::RedirectCount.") },
            ResourceAttribute::RequestStart => self.request_start = 0,
            ResourceAttribute::ResponseStart => self.response_start = 0,
            ResourceAttribute::RedirectStart(_) => self.redirect_start = 0,
            ResourceAttribute::RedirectEnd(_) => self.redirect_end = 0,
            ResourceAttribute::FetchStart => self.fetch_start = 0,
            ResourceAttribute::ConnectStart(_) => self.connect_start = 0,
            ResourceAttribute::ConnectEnd(_) => self.connect_end = 0,
            ResourceAttribute::SecureConnectionStart => {
                self.secure_connection_start = 0
            },
            ResourceAttribute::ResponseEnd => self.response_end = 0,
        }
    }
